                    ...
                    <div className="col-lg-6 mt-4 mt-lg-0">
                        ...
                        <div className="social-icon">
                            <ul className="list-inline py-2 mb-0">
                                <li className="list-inline-item"><a href="javascript:void(0);"><img src="assets/img/facebook.svg" alt=""/></a></li>
                                <li className="list-inline-item"><a href="javascript:void(0);"><img src="assets/img/twitter.svg" alt=""/></a></li>
                                <li className="list-inline-item"><a href="javascript:void(0);"><img src="assets/img/github.svg" alt=""/></a></li>
                                <li className="list-inline-item"><a href="javascript:void(0);"><img src="assets/img/linkedin.svg" alt=""/></a></li>
                                <li className="list-inline-item"><a href="javascript:void(0);"><img src="assets/img/telegram.svg" alt=""/></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
